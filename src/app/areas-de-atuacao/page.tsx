...
export const metadata: Metadata = { title: "Áreas de Atuação", description: "Conheça as principais áreas de atuação em Direito Penal e Processo Penal da Barbara Cordeiro Advocacia Criminal.", alternates: { canonical: "/areas-de-atuacao" } };
